<script lang="ts">
	...
	const MEDALS: Record<number, Medal> = {
		1: { body: '#f6c341', ring: '#bf8e2b', textFill: '#5c3908', accent: '#bf8e2b', bgTint: 'rgba(246,195,65,0.10)',  barFill: '#bf8e2b' },
		2: { body: '#c9b6c5', ring: '#958191', textFill: '#1a1a1a', accent: '#958191', bgTint: 'rgba(201,182,197,0.12)', barFill: '#958191' },
		3: { body: '#ea662f', ring: '#ab4723', textFill: '#fff',    accent: '#ab4723', bgTint: 'rgba(234,102,47,0.08)',  barFill: '#ab4723' },
	};
	const DEF_BAR   = '#317a68'; // teal[2]
